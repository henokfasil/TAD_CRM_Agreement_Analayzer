...
from app.services.review.adjudication import adjudications_to_csv
...
def build_workspace_summary(
    ...
    return {
        ...
        "adjudicated_decisions": len(adjudications or []),
...
def build_research_export_bundle(
    ...
    adjudication_records = adjudications or []
    ...
    return {
        ...
        "adjudications_csv": adjudications_to_csv(adjudication_records),
    }
